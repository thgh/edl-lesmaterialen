...
export default function ImportXLSXPage() {
  ...
  const [deleteAll, setDeleteAll] = useLocalStorage('import-deleteAll', false)
  const [isPublished, setIsPublished] = useLocalStorage('import-isPublished', true)
