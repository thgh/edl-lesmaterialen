...
export function Header({ locale }: HeaderProps) {
  ...
  return (
    <header className="w-full min-h-0 md:min-h-[150px] flex items-center border-b border-gray-200 bg-white py-4 ">
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4 w-full mx-auto max-w-[1400px]  px-4 sm:px-6 lg:px-8">
        ...
        <div className="hidden md:flex shrink-0 items-center gap-2 md:gap-8">
          <Link href="/" className="flex items-center gap-2 mr-4" prefetch={false}>
            <img src="/assets/logo-edl.png" alt="EDL" className="md:h-12 lg:h-16" />
            <span className="sr-only">EDL Münster</span>
          </Link>
          <Link href="/" className="flex items-center gap-2" prefetch={false}>
            <img src="/assets/logo-zns.svg" alt="ZNS" className="md:h-12 lg:h-16" />
          ...
          <img
            ...
            className="h-10 w-auto object-contain mix-blend-multiply md:h-[130px]"
          />
        </div>
      </div>
    </header>
